...
export const KEY_AWS_ETH_NAME_LIVE = 'price-feed-private-Live';
...
export const KEY_AZURE_ETH_NAME_LIVE = 'price-feed-private-Live';
...
export const KEY_GCP_ETH_NAME_LIVE = 'price-feed-private-Live';
