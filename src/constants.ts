...
export const DB_EV_CREATE_A = 'createdTokenAInWei';
export const DB_EV_CREATE_B = 'createdTokenBInWei';
export const DB_EV_REDEEM_A = 'redeemedTokenAInWei';
export const DB_EV_REDEEM_B = 'redeemedTokenBInWei';
