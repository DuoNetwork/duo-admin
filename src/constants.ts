...
export const DB_HR_OPEN = 'open';
export const DB_HR_HIGH = 'high';
export const DB_HR_LOW = 'low';
export const DB_HR_CLOSE = 'close';
export const DB_HR_VOLUME = 'volume';
export const DB_HR_TS = 'timestamp';
